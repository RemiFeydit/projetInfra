...
case $action in
    "save")
        ...
        case $nomSauvegarde in
            world|server.properties)
                borg delete ../backupMinecraft/backup::$nomSauvegarde_$(cat versionActuelle.txt) 
                borg create ../backupMinecraft/backup::$nomSauvegarde_$(cat versionActuelle.txt)  $nomSauvegarde
                ;;
             all)
                borg delete ../backupMinecraft/backup::world_$(cat versionActuelle.txt) 
                borg create ../backupMinecraft/backup::world_$(cat versionActuelle.txt)  world
    ...
    "restore")
        ...
        case $nomSauvegarde in
            world|server.properties)
                borg extract ../backupMinecraft/backup::$nomSauvegarde_$(cat versionActuelle.txt) 
                ;;
             all)
                borg extract ../backupMinecraft/backup::world_$(cat versionActuelle.txt) 
